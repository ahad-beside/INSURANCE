...
<head>
    ...
    <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/js/jquery-1.11.0.js"></script>
    ...
    <!-- MetisMenu CSS -->
    <link href="<?php echo Yii::app()->theme->baseUrl?>/assets/css/plugins/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo Yii::app()->theme->baseUrl?>/assets/css/sb-admin-2.css" rel="stylesheet">
