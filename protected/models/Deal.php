...
class Deal extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('name, update_by, update_time, from, until', 'required'),
            array('status, update_by', 'numerical', 'integerOnly' => true),
            array('name', 'length', 'max' => 100),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, until, status, update_by, update_time', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'dealItems' => array(self::HAS_MANY, 'DealItems', 'deal_id'),
        );
    }
