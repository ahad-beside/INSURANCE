 ...
 *
 * The followings are the available columns in table 'products_filter':
 * @property integer $id
 ...
 */
class ProductsFilter extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, product_id, filter_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ProductsFilter the static model class
	 */
