    ...
    <div class="col-md-12">
        <table class="table table-striped" style="border-top:1px solid #CCC; font-family:Verdana, Geneva, sans-serif; font-size:12px; margin-top:12px; width: 100%; border-collapse: collapse;" border="1" cellpadding="4">
            ...
            <tbody>
                ...
                if (count($products) > 0) {
                    ...
                    foreach ($products as $product):
                        ...
                        <tr>
                            ...
                            <td align="left" valign="middle"><?php echo Products::model()->findByPk((int) $product->product_id)->name;
                        ?></td>
                            <td align="right" valign="middle"><?php echo $product->qty ?></td>
                            <td align="right" valign="middle"><?php echo $product->unit_price ?></td>
                            <td align="right" valign="middle"><?php
                                echo number_format($product->unit_price * $product->qty, 2);
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="3" align="right" valign="middle"><strong>Sub Total</strong></td>
                    <td align="right" valign="middle"><strong><?php echo number_format($subtotal, 2) ?></strong></td>
                ...
                <tr>
                    ...
                    <td align="right" valign="middle"><strong><?php echo number_format($subtotal + (int) $model->delivery_charge, 2) ?></strong></td>
