...
class SiteController extends Controller {
	...
	//start mail send to customar
		...
		'residence'=>$residence, 'email'=>$email, 'phone'=>$phone, 'today'=>$today, 'pdob'=>$pdob, 'age'=>$age,
				...
				$mailCompare->setCc(array('info@hamiltonhudson.com', 'office@hamiltonhudson.com', 's.titas92@gmail.com', 'lifeinsuranceabroad@gmail.com'));
    ...
    public function actionRequest() {
		...
		if (isset($_POST['submit'])) {
			...
			if ($model->save()) {
				...
				$mail->setTo(array('info@hamiltonhudson.com', 'office@hamiltonhudson.com', 's.titas92@gmail.com' , 'lifeinsuranceabroad@gmail.com'));
