...
class SiteController extends Controller {
	...
	//start mail send to customar
		...
		'residence'=>$residence, 'email'=>$email, 'phone'=>$phone, 'today'=>$today, 'pdob'=>$pdob, 'age'=>$age,
				...
				$mailCompare->setCc(array('info@hamiltonhudson.com', 'office@hamiltonhudson.com', 's.titas92@gmail.com', 'engamahmood@gmail.com', 'lifeinsuranceabroad@gmail.com'));
    ...
    public function actionRequest() {
		...
		if (isset($_POST['submit'])) {
			...
			if ($model->save()) {
				...
				$mail->setTo(array('info@hamiltonhudson.com', 'office@hamiltonhudson.com', 's.titas92@gmail.com' , 'engamahmood@gmail.com',  'lifeinsuranceabroad@gmail.com'));
...
A client services representative will phone you shortly at the telephone number you provided to verify your personal data.  If in the meantime you have any questions or concerns, please feel free to call on us anytime at<br/>
 +420.777 322 522 or from the U.S. +1.616.723.0580 <br/>
    ...
    public function actionPopup($id='') {
	 ...
	 public function actionForm() {
       ...
       // echo $annualRate; exit();
        $this->render('form', array('annualRate'=>$annualRate, 'name'=>$name, 'amount'=>$amount, 'sex'=>$gender, 'type'=>$type, 'companyName'=>$companyName, 'companyImage'=>$companyImage, 'birthDay'=>$birthDay, 'birthMonth'=>$birthMonth, 'birthYear'=>$birthYear, 'sex'=>$gender, 'smoker'=>$smoker, 'health'=>$health, 'citizenship'=>$citizenship, 'residence'=>$residence, 'email'=>$email, 'phone'=>$phone, 'age'=>$age, 'dob'=>$dob));
    }
