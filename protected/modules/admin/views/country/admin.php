...
<div class="row open_page">
    <div class="col-md-12 custom-page-header">
        ...
        <div class="col-md-6 action-button">
            <?php
            echo CHtml::link('<i class="fa fa-plus"></i>', $this->createUrl('country/create'), array('class' => 'btn btn-default btn-circle', 'title' => 'New'));
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Manage Country</div>
