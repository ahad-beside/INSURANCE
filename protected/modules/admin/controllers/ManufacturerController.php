...
class ManufacturerController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Manufacturer'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', "Success: Manufacturer created successfully");
        ...
        $model->sort_order = Yii::app()->easycode->getLastSortingNumber('Manufacturer', 'sort_order');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Manufacturer'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', "Manufacturer updated successfully");
                $this->redirect(array('admin'));
            } else {
                Yii::app()->user->setFlash('warning', "Warning: Please check the form carefully for errors!");
            }
