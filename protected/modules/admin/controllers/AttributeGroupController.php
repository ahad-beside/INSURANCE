...
class AttributeGroupController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['AttributeGroup'])) {
            ...
            if ($model->save()){
                Yii::app()->user->setFlash('success', "Success: Arrtibute Group created successfully");
        ...
        $model->sort_order = Yii::app()->easycode->getLastSortingNumber('AttributeGroup','sort_order');
